...
"""%(N))                                                    
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Nama       : ARMAN KING
 [\x1b[1;96m+%s] WhatsApp   : +88013188058**
 [\x1b[1;96m+%s] Facebook   : MD ARMAN HOSSAIN 
 [\x1b[1;96m+%s] Github      : https://github.com/arman3/Arman-king
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
def kontol():
    os.system("clear")
    print(f"""         _                               
...
{B} |
{P}[•] AUTHOR: ARMAN VAI
{P}[•] WHATSAPP: +88013188058**
{B}[•] FACEBOOK: MD ARMAN HOSSAIN""")
def licensi():#line:42
  try :#line:43
    os .system ('clear')
    kontol()
...
""")#line:49
    ...
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{P}!{H}]{P} Anda Akan Diarahkan Ke Whatsapp...");time .sleep (3 );os .system ('xdg-open https://wa.me/+8801318805859?text=Bang+Yogi+Beli+Lisensi');exit ()#line:52
